    ...
    <div class="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-6 sm:p-8">
        <form action="{{ route('expenses.update', $expense) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <select name="expense_category_id" required class="w-full px-3.5 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-500 focus:outline-none transition">
            ...
            <div>
                ...
                <textarea name="note" rows="3"
                          class="w-full px-3.5 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-500 focus:outline-none transition">{{ old('note', $expense->note) }}</textarea>
            </div>
